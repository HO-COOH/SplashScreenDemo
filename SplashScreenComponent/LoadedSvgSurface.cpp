	...
	}
{
	...
	POINT offset{};
	winrt::check_hresult(drawingSurfaceInterop->BeginDraw(nullptr, IID_PPV_ARGS(d2dContext.put()), &offset));
	DrawSvg(svg, { size.Width, size.Height }, d2dContext.get(), offset);
